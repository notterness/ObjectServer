...
public class ThreadSafeBufferManager {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ThreadSafeBufferManager.class);
    ...
    public ThreadSafeBufferManager(final int bufferCount, final String bufferMgrName, final int identifier) {
        ...
        this.registeredPointers = new ConcurrentHashMap<>();
    }
