...
public class SSLContentReadPipelineMgr extends ConnectionPipelineMgr {
    ...
    private Function contentReadSetup = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
    ...
    private Function contentReadRequestDataBuffers = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn) {
    ...
    private Function contentReadDataBuffers = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn) {
    ...
    private Function contentReadCheckSlowChannel = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn) {
    ...
    private Function contentReadSendXferResponse = new Function<WebServerSSLConnState, StateQueueResult>() {
        public StateQueueResult apply(WebServerSSLConnState wsConn) {
    ...
    private Function contentReadConnFinished = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn) {
            initialStage = true;
            wsConn.reset();
    ...
    private Function contentReadSetNextPipeline = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn) {
            initialStage = true;
    ...
    private Function contentReadProcessReadError = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn){
    ...
    private Function contentReadProcessFinalResponseSend = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn){
    ...
    private Function contentReadReleaseBuffers = new Function<WebServerSSLConnState, StateQueueResult>() {
        @Override
        public StateQueueResult apply(WebServerSSLConnState wsConn){
    ...
    SSLContentReadPipelineMgr(WebServerSSLConnState connState) {
