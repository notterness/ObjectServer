...
public class GetBucketLifecycleHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final EmbargoV3 embargoV3;

    public GetBucketLifecycleHandler(S3Authenticator authenticator,
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            backend.getBucketLifecycleConfiguration(context, authInfo, namespace, bucketName);
        } catch (Exception ex) {
