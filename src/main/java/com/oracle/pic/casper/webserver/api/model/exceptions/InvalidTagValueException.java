...
public class InvalidTagValueException extends RuntimeException implements CasperHttpException {

    public InvalidTagValueException(String msg) {
        super(msg);
    }

    @Override
    public V2ErrorCode errorCode() {
        return V2ErrorCode.INVALID_TAG_VALUE;
    }
