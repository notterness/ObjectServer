...
public class GetBucketRequestPaymentHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final XmlMapper mapper;
    private final EmbargoV3 embargoV3;

    public GetBucketRequestPaymentHandler(S3Authenticator authenticator,
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            final BucketRequestPayment result = backend.getBucketRequestPayment(context,
