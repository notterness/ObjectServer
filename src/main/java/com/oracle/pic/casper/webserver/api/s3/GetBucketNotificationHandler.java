...
public class GetBucketNotificationHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final XmlMapper mapper;
    private final EmbargoV3 embargoV3;

    public GetBucketNotificationHandler(S3Authenticator authenticator,
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            final BucketNotificationConfiguration result = backend.getBucketNotificationConfiguration(context,
                    authInfo, namespace, bucketName);
