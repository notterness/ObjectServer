...
public class GetBucketLocationHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final XmlMapper mapper;
    private final EmbargoV3 embargoV3;

    public GetBucketLocationHandler(
            S3Authenticator authenticator, BucketBackend backend, XmlMapper mapper, EmbargoV3 embargoV3) {
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            final LocationConstraint result = backend.getBucketLocation(context, authInfo, namespace, bucketName);
