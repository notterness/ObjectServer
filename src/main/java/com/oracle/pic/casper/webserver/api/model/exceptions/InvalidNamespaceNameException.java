...
public class InvalidNamespaceNameException extends RuntimeException implements CasperHttpException {
    public InvalidNamespaceNameException(String msg) {
        super(msg);
    }

    @Override
    public V2ErrorCode errorCode() {
        return V2ErrorCode.INVALID_NAMESPACE_NAME;
    }
