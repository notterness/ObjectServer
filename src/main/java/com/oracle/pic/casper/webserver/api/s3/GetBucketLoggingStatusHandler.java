...
public class GetBucketLoggingStatusHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final XmlMapper mapper;
    private final EmbargoV3 embargoV3;

    public GetBucketLoggingStatusHandler(S3Authenticator authenticator,
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            final BucketLoggingStatus result = backend.getBucketLoggingStatus(context,
