...
public class GetBucketCORSHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final EmbargoV3 embargoV3;

    public GetBucketCORSHandler(S3Authenticator authenticator,
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            backend.getBucketCORSConfiguration(context, authInfo, namespace, bucketName);
        } catch (Exception ex) {
