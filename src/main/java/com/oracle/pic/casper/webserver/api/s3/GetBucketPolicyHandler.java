...
public class GetBucketPolicyHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final EmbargoV3 embargoV3;

    public GetBucketPolicyHandler(S3Authenticator authenticator,
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            backend.getBucketPolicyConfiguration(context, authInfo, namespace, bucketName);
        } catch (Exception ex) {
