...
public class InvalidReplicationPolicyIdException extends RuntimeException implements CasperHttpException {
    public InvalidReplicationPolicyIdException(String msg) {
        super(msg);
    }

    @Override
    public V2ErrorCode errorCode() {
        return V2ErrorCode.INVALID_REPLICATION_POLICY_ID;
    }
