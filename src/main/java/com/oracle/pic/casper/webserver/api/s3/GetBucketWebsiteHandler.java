...
public class GetBucketWebsiteHandler extends SyncHandler {
    private final S3Authenticator authenticator;
    private final BucketBackend backend;
    private final EmbargoV3 embargoV3;

    public GetBucketWebsiteHandler(S3Authenticator authenticator,
    ...
    public void handleSync(RoutingContext context) {
        ...
        try {
            ...
            backend.getBucketWebsiteConfiguration(context, authInfo, namespace, bucketName);
        } catch (Exception ex) {
