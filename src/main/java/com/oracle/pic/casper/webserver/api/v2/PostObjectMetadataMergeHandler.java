...
/**
 * Vert.x HTTP handler for merging object's metadata with existing metadata.
 */
public class PostObjectMetadataMergeHandler extends SyncBodyHandler {
    ...
    public PostObjectMetadataMergeHandler(Authenticator authenticator,
                                          Backend backend,
                                          ObjectMapper mapper,
    ...
    public void handleBody(RoutingContext context, byte[] bytes) {
        ...
        WSRequestContext.setOperationName(Api.V2.getVersion(), getClass(), context,
            CasperOperation.MERGE_OBJECT_METADATA);
        ...
        final EmbargoV3Operation embargoV3Operation = EmbargoV3Operation.builder()
            ...
            .setOperation(CasperOperation.MERGE_OBJECT_METADATA)
        ...
        final UpdateObjectMetadataDetails details = HttpContentHelpers
                .getUpdateObjectMetadataDetails(request, mapper, bytes, true);
        ...
        try {
            ...
            PostObjectMetadataResponse result = backend.mergeObjectMetadata(context, authInfo, namespace, bucketName,
