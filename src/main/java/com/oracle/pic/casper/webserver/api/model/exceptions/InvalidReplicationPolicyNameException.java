...
public class InvalidReplicationPolicyNameException extends RuntimeException implements CasperHttpException {
    public InvalidReplicationPolicyNameException(String msg) {
        super(msg);
    }

    @Override
    public V2ErrorCode errorCode() {
        return V2ErrorCode.INVALID_REPLICATION_POLICY_NAME;
    }
