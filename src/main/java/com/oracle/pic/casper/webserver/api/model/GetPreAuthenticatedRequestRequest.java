...
public final class GetPreAuthenticatedRequestRequest {
    ...
    public GetPreAuthenticatedRequestRequest(RoutingContext context, AuthenticationInfo authInfo, BackendParId parId) {
    ...
    public String toString() {
        return "GetPreAuthenticatedRequestRequest{" +
                "authInfo=" + authInfo +
                ", parId=" + parId +
                '}';
    }
