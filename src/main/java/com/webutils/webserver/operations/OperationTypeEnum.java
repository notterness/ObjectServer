...
public enum OperationTypeEnum {
    ...
    CREATE_OBJECT(20),
    SETUP_OBJECT_GET(21),
    SETUP_OBJECT_DELETE(22),
    SETUP_OBJECT_LIST(23),
    SETUP_OBJECT_PUT(24),
    SETUP_BUCKET_POST(25),
    SETUP_BUCKET_DELETE(26),
    ...
    DELETE_OBJECT(311),
    SEND_BUCKET_DELETE_RESPONSE(312),
    ...
    ** The following are operations that are run as part of the ChunkMgr service
    ...
    ACCOUNT_MGR_SEND_FINAL_STATUS(950),
    ACCOUNT_MGR_DETERMINE_REQUEST(951),
    CREATE_TENANCY(952),
    SETUP_TENANCY_POST(953),
    SETUP_USER_POST(954),
    CREATE_USER(955),
    SETUP_ACCESS_TOKEN_GET(956),
    GET_ACCESS_TOKEN(957),
