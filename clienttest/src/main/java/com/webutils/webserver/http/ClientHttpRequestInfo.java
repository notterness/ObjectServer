...
public class ClientHttpRequestInfo extends HttpRequestInfo {

    private static final Logger LOG = LoggerFactory.getLogger(ClientHttpRequestInfo.class);

    public ClientHttpRequestInfo() {
        super();
    }
