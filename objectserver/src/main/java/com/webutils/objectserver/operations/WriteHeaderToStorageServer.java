...
public class WriteHeaderToStorageServer implements Operation {
     ...
     */
    private final OperationTypeEnum operationType = OperationTypeEnum.WRITE_HEADER_TO_STORAGE_SERVER;
    ...
    ** At this point, all communications with the Storage Server for this chunk of data have been completed.
    ...
    public void markRemovedFromQueue(final boolean delayedExecutionQueue) {
        //LOG.info("WriteHeaderToStorageServer[" + requestContext.getRequestId() + "] markRemovedFromQueue(" + delayedExecutionQueue + ")");
        if (delayedExecutionQueue) {
            LOG.warn("WriteHeaderToStorageServer[" + requestContext.getRequestId() + "] markRemovedFromQueue(" +
    ...
    public void markAddedToQueue(final boolean delayedExecutionQueue) {
        if (delayedExecutionQueue) {
            LOG.warn("WriteHeaderToStorageServer[" + requestContext.getRequestId() + "] markAddToQueue(" +
                    delayedExecutionQueue + ") not supposed to be on delayed queue");
        } else {
    ...
    public boolean hasWaitTimeElapsed() {
        LOG.warn("WriteHeaderToStorageServer[" + requestContext.getRequestId() +
