...
public class HandleChunkWriteConnError implements Operation {
    ...
    **   dropped the connection during the transfer.
    ...
    HandleChunkWriteConnError(final RequestContext requestContext, final SetupChunkWrite chunkWrite, final ServerIdentifier serverIdentifier) {
    ...
    public void complete() {
        LOG.error("HandleChunkWriteConnError complete() should never be here!");
    }
