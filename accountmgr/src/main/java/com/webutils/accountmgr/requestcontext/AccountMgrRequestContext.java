...
public class AccountMgrRequestContext extends RequestContext {

    private static final Logger LOG = LoggerFactory.getLogger(AccountMgrRequestContext.class);
    ...
    private AccountMgrDetermineRequest determineRequest;

    private AccountMgrSendFinalStatus sendFinalStatus;
    ...
    public AccountMgrRequestContext(final MemoryManager memoryManager, final HttpRequestInfo httpInfo,
    ...
    public void initializeServer(final IoInterface connection, final int requestId) {
         ...
         */
        sendFinalStatus = new AccountMgrSendFinalStatus(this, memoryManager);
         ...
         */
        determineRequest = new AccountMgrDetermineRequest(this, supportedHttpRequests);
         ...
         */
        SetupTenancyPost createTenancyHandler = new SetupTenancyPost(this, metering, determineRequest);
        supportedHttpRequests.put(HttpMethodEnum.POST_TENANCY_METHOD, createTenancyHandler);
    ...
    public void cleanupServerRequest() {
        ...
        operation = requestHandlerOperations.remove(OperationTypeEnum.ACCOUNT_MGR_SEND_FINAL_STATUS);
        operation.complete();
        ...
        operation = requestHandlerOperations.remove(OperationTypeEnum.ACCOUNT_MGR_DETERMINE_REQUEST);
        operation.complete();
